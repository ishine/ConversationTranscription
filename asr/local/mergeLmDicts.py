#!/usr/bin/env python3
"""
Now that we have our language model and Phoneme Dicts
we need to merge them with the existing language model and dicts from the ASPIRE model
leveraging merging code found here: https://chrisearch.wordpress.com/2017/03/11/speech-recognition-using-kaldi-extending-and-using-the-aspire-model

basedic = aspire original dictionary
baselm = aspire original language model
extdic = newly created dictionary
extlm = newly created language model
outdic = merged dictionary output name
outlm = merged language model output name
/
"""
